  ...
  return (
	...
	<header>
		<nav className="navbar navbar-expand-lg navbar-light bg-color fixed-top">
			<a className="navbar-brand" href="../index.html"><img src="../media/logo2.png" alt="" width="150"/></a>
	...
	<div className="main-area">
		<div className="bt-area">
			...
			<img src="../media/線段.jpg" width="1px" height="50px" className="btline"/>
		...
		<div className="news-area">
			...
			<div className="first-news">
				<br/>
				<img className="news-img" src="../media/新聞大圖.png"/>
				...
				<img className="line" src="../media/線段.jpg"/>
	...
	<footer>
		<a href="../index.html"><img className="big-logo" src="../media/logo2.png"/></a>
		<div className="footer-top">
			<div className="footer-icon">
				<a href="https://www.facebook.com/TerrariaOfficial/"><img src="../media/fb.png"height="20"/></a>
				<a href="https://twitter.com/terraria_logic"><img src="../media/twitter.png"height="20"/></a>
				<a href="https://www.instagram.com/terraria_logic/?hl=zh-tw"><img src="../media/ig.png"height="20"/></a>
				<a href="https://www.youtube.com/user/demilogic"><img src="../media/yt.png"height="20"/></a>
			</div>
		</div>
		<div className="gift" >
				
			<img className="gif" src="../gif/120.gif"/>
			<img className="gif" src="../gif/Empress_of_Light.gif"/>
			<img className="gif" src="../gif/Skeletron_Prime_.gif"/>
			<img className="gif" src="../gif/queen_slime.gif"/>
			<img className="gif" src="../gif/Webp.net-gifmaker.gif"/>
